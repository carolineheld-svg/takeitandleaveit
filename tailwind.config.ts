  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-light-purple': 'linear-gradient(135deg, #faf8ff 0%, #f5f0ff 100%)',
        'gradient-light-blue': 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%)',
        'gradient-light-green': 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)',
      },
      boxShadow: {
